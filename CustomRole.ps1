...
$CUSTOM_ROLENAME = 'API Mgmt Access for ' + $APIM_SVC_NAME + " " +  $API_NAME  #The Custom Role Name you want to use
...
$group_info = Get-AzADGroup -DisplayNameStartsWith $GroupName
$group_ObjectId = $group_info.Id
...
New-AzRoleAssignment -ObjectId $group_ObjectId -RoleDefinitionName $CUSTOM_ROLENAME -Scope $AssignableScope
